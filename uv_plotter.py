...
cuvettes_used = st.text_input('Type the number of measurements done in your experiment/nIf you did a time trial,  [Measurements  = (# Cuvettes Loaded) x (# Timepoints)]' ) 
